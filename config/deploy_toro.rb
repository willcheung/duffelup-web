...
#set :port, 8888
set :deploy_to, "/home/duffel/#{application}"

# If you aren't using Subversion to manage your source code, specify
# your SCM below:
# set :scm, :subversion

role :app, "toro.duffelup.com"
role :web, "toro.duffelup.com"
role :db,  "toro.duffelup.com", :primary => true
...
#############################################################
  ...
  task :copy_database_configuration do
      production_db_config = "/home/duffel/prod/production.database.yml"
