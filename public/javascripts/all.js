...
function slideSideBar(){
	...
	new Effect.toggle('sliding-sideBarContents', 'blind', {scaleX: 'true', scaleY: 'true;', scaleContent: false, duration: 0.5});
	
	if(isExtended==0){
		$('sliding-sideBarTab').childNodes[0].src = $('sliding-sideBarTab').childNodes[0].src.replace(/(\.[^.]+)$/, '-open$1');
		
		new Effect.Fade('sliding-sideBarContents',
...
http://www.sthoughts.com/prototype-masonry/
***************************/
Element.Storage = {
  UID: 1
};
