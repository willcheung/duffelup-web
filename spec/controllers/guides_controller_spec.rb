...
describe GuidesController do
  ...
  describe "GET index" do
    it "assigns all guides as @guides" do
      Guide.stub(:find).with(:all).and_return([mock_guide])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested guide as @guide" do
      Guide.stub(:find).with("37").and_return(mock_guide)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new guide as @guide" do
      Guide.stub(:new).and_return(mock_guide)
      get :new
      assigns[:guide].should equal(mock_guide)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created guide as @guide" do
        Guide.stub(:new).with({'these' => 'params'}).and_return(mock_guide(:save => true))
